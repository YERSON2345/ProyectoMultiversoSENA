            ...
            <div class="contact-form">
                ...
                <form action="compras" method="post">
					 ...
					 <div class="col-md-3">
						...
						<select class="form-select" id="noDocCliente validationCustom04" name="idProducto" required>
							<option selected disabled value="">Seleccione</option>
							<c:forEach var="idProducto" items="${idProducto}">
								<option value="${idProducto.getIdProducto()}">${idProducto.getNombreProducto()}</option>
							</c:forEach>
						</select>
					  ...
					  <div class="col-md-3">
						<label for="validationCustom04" class="form-label">Proveedro del Producto</label>
						<select class="form-select" id="noDocCliente validationCustom04" name="idProveedor" required>
							<option selected disabled value="">Seleccione</option>
							<c:forEach var="idProveedor" items="${idProveedor}">
								<option value="${idProveedor.getIdProveedor()}">${idProveedor.getNombreProveedor()}</option>
							</c:forEach>
						</select>
						<div class="valid-feedback">
							¡Todo correcto!
