								...
								<form action="salidas" method="post" class="needs-validation" novalidate>
									<div class="form-group">
										...
										<label class="col-sm-5 control-label">
											ID Producto: ${salir.getIdProducto()} <br>
											Producto: ${salir.getNombreProducto()} <br>
											Tipo de producto: ${salir.getNombreTipoProducto()} <br>
											Observaciones: ${salir.getObservacionesProducto()}  <br>
											Cantidad: ${salir.getCantidadProducto()} <br>
											Precio: ${salir.getPrecioProducto()} <br>
									...
									<div class ="form-group">
										...
										<div class="col-sm-5">
										<input name="cantidadProducto"type="hidden" class ="form-control" placeholder="20 unidades" value="${salir.getCantidadProducto()}">
										</div>
									...
									<div class ="form-group">
										...
										<div class="col-sm-5">
										<input name="nombreProducto"type="hidden" class ="form-control" placeholder="20 unidades" value="${salir.getNombreProducto()}">
										</div>
									...
									<div class ="form-group">
										...
										<div class="col-sm-5">
										<input name="idProducto"type="hidden" class ="form-control" placeholder="20 unidades" value="${salir.getIdProducto()}">
										</div>
									...
									<br>
									 <button class="btn btn-primary" type="submit" id="form-submit" name="condicion" value="insertar">Enviar</button>
								</div>
								</form>
							</c:forEach>
							</div>
