									...
									<div class="form-group">
										...
										<div class="col-sm-10">
											<input type="text" id="validationCustom01" name="nombre"
												class="form-control" minlength="4" maxlength="20" placeholder="Nombre Del Producto" required>

											<div class="valid-feedback">
												¡Nombre del producto insertado con éxito!
											</div>
											<div class="invalid-feedback">
												¡El nombre del producto no puede estar vacio, o tener menos de 4 letras!
											</div>
										</div>
									</div>
