	...
	<a class="sidebar-link" href="salidas?condicion=consultarSalidas">
		...
		<div class="main">
          ...
          <i class="hamburger align-self-center"></i>
                ...
                <img src="assets/img/avatar.jpg" class="avatar img-fluid rounded me-1" alt="Charles Hall" /> <span class="text-dark">Nicolas Peraza</span>
              </a>
            ...
            <div class="contact-form">
                ...
                <form action="producto" method="post" class="needs-validation" novalidate>
					...
					<div class="form-group">
						<label for="validationCustom01 observaciones" class="col-sm-2 control-label">Observaciones del producto</label>
						<div class="col-sm-10">
							<input type="text" id="validationCustom01" name="observaciones" class="form-control" placeholder="Observaciones Del Producto" required >
					...
					<div class="form-group">
						<label for="validationCustom01 nombre" class="col-sm-2 control-label">Nombre del producto</label>
						<div class="col-sm-10">
							<input type="text" id="validationCustom01" name="nombre" class="form-control" placeholder="Nombre Del Producto" required >
					...
					<div class="form-group">
						<label for="validationCustom01 nombre" class="col-sm-2 control-label">Precio Del Producto</label>
						<div class="col-sm-10">
							<input type="number" id="validationCustom01" name="precio" class="form-control" placeholder="Precio Del Producto" required >
					...
					<div class="form-group">
						<label for="validationCustom01 nombre" class="col-sm-2 control-label">Cantidad Del Producto</label>
						<div class="col-sm-10">
							<input type="number" id="validationCustom01" name="cantidad" class="form-control" placeholder="Cantidad Del Producto" required >
					...
					<div class="col-md-3">
						...
						<select class="form-select" id="noDocCliente validationCustom04" name="IdTipoProducto" required>
							<option selected disabled value="">Seleccione</option>
							<c:forEach var="idTipoProducto" items="${idTipoProducto}">
								<option value="${idTipoProducto.getIdTipoProducto()}">${idTipoProducto.getNombreTipoProducto()}</option>
							</c:forEach>
						</select>
						<div class="valid-feedback">
							¡Todo correcto!
