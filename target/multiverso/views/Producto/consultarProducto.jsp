...
<body>
	...
	<div class="wrapper">	<nav id="sidebar" class="sidebar js-sidebar">
    ...
    <tr>
      ...
      <td>${producto.getObservacionesProducto()}</td>
      ...
      <c:if test="${producto.getEstadoProducto() == false}">
        <td><span class="offline"></span></td>
      </c:if>
        <c:if test="${producto.getEstadoProducto() == true}">
          <td>
            <a href="producto?accion=estadoProducto&idProducto=${producto.getIdProducto()}&estadoProducto=false"><button class="btn btn-success" type="button"> Inactivar</button></a>
          </td>
        </c:if>

        <c:if test="${producto.getEstadoProducto() == false}">
          <td>
            <a href="producto?accion=estadoProducto&idProducto=${producto.getIdProducto()}&estadoProducto=true"><button class="btn btn-success" type="button"> Activar</button></a>
          </td>
        </c:if>
        <td>
          <a href="producto?accion=eliminar&idProducto=${producto.getIdProducto()}"> <button class="btn btn-danger" type="button"> Eliminar</button></a><br> 
          <a href="producto?accion=editar&idProducto=${producto.getIdProducto()}"> <button class="btn btn-primary" type="button"> Editar</button></a>
        </td>
    </tr>
  </c:forEach>
</tbody>
