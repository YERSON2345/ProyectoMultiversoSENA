													...
													<table class="datatable" id="datatable">
														<thead>
															<tr>
																...
																<th>
																	<p class="white">id Producto</p>
																</th>
																<th>
																	<p class="white">Fecha Vencimiento</p>
																</th>
																<th>
																	<p class="white">Observaciones del Producto</p>
																</th>
																<th>
																	<p class="white">Nombre Del Producto</p>
																</th>
																<th>
																	<p class="white">Precio del Producto</p>
																</th>
																<th>
																	<p class="white">Cantidad del Producto</p>
																</th>
																<th>
																	<p class="white">Tipo Producto</p>
																</th>
																<th>
																	<p class="white">Estado Producto</p>
																</th>
																<th>
														...
														<tbody>
															<c:forEach var="producto" items="${producto}">
																<tr>
																	<td></td>
																	<td>
																		<p class="white">${producto.getIdProducto()}</p>
																	</td>
																	<td>
																		<p class="white">${producto.getfechaVencimiento()}</p>
																	</td>
																	<td>
																		<p class="white">
																			${producto.getObservacionesProducto()}</p>
																	</td>
																	<td>
																		<p class="white">${producto.getNombreProducto()}
																		</p>
																	</td>
																	<td>
																		<p class="white">${producto.getPrecioProducto()}
																		</p>
																	</td>
																	<td>
																		<p class="white">
																			${producto.getCantidadProducto()}</p>
																	</td>
																	<td>
																		<p class="white">
																			${producto.getNombreTipoProducto()}</p>
																	</td>
