							...
							<div class="contact-form">
								...
								<c:forEach var="detalleCompras" items="${detalleCompras}">
									<form action="detalleCompras" method="post">
										<p>
											<label class="font-weight-bold">Fecha De Vencimiento<span
													class="text-danger">*</span></label>
											<input type="date" name="fecha"
												value="${detalleCompras.getFechaVencimientoProducto()}"
												placeholder="Fecha De Vencimiento" class="form-control">
										</p>
										<p>
											<label class="font-weight-bold">Cantidad De la Compra<span
													class="text-danger">*</span></label>
											<input type="number" name="cantidad"
												value="${detalleCompras.getCantidadCompra()}"
												placeholder="Cantidad De la Compra" class="form-control">
										</p>
										<p>
											<label class="font-weight-bold">Precio Del Proveedor<span
													class="text-danger">*</span></label>
											<input type="number" name="precio"
												value="${detalleCompras.getPrecioProveedor()}"
												placeholder="Precio Del Proveedor" class="form-control">
										</p>
										<p>
										<div class="form-group mb-5">
											<div class="form-check">
												<input class="form-check-input" type="checkbox">
												<label class="form-check-label text-muted">Aceptar terminos y
													condiciones</label>
											</div>
										</div>
										</p>
