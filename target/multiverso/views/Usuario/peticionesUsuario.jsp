					...
					<div class="agileits-pricing-grid first">
						<div class="pricing_grid">
							<div class="wthree-pricing-info pricing-top">
								...
								<p><span>${usuario.getNombreUsuario()} </span><span>${usuario.getApellidoUsuario()}</span></p>
							</div>
							<div class="pricing-bottom">
								<div class="pricing-bottom-bottom">
									<p><span class="fa fa-check"></span>Número de documento: <span>${usuario.getNoDocUsuario()}</span></p>
									<p><span class="fa fa-check"></span>Tipo de documento: <span>${usuario.getTipoDocUsuario()}</span></p>
									<p><span class="fa fa-check"></span>Correo electronico: <span>${usuario.getCorreoUsuario()}</span></p>
								...
								<div class="buy-button">
									<a class="popup-with-zoom-anim" href="usuario?condicion=cambioEstado&id=${usuario.getNoDocUsuario()}&estado=true" onclick="return confirmar()">Aceptar</a>
									<a class="btn btn-warning" href="usuario?condicion=eliminar&id=${usuario.getNoDocUsuario()}" onclick="return eliminar()">Rechazar</a>
								</div> 
						...
						<div class="pricing_grid">
							...
							<div class="pricing-bottom">
								<div class="pricing-bottom-bottom">
									...
									<p><span class="fa fa-check"></span>Correo electronico: <span>Yerson.Bohorqueza14@gmail.com</span></p>
									<p><span class="fa fa-check"></span>Rol: <span>Gerente</span></p>
								</div>
								<div class="buy-button">
