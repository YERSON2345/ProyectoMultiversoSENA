					...
					<div class="content">
						<div class="contact-wrapper animated bounceInUp">
							<div class="contact-form">
								<h3>Proveedor</h3>
								<form class="needs-validation" action="proveedor" method="post" novalidate>
									...
									<div class="form-group">
										...
										<div class="col-sm-10">
											<input type="text" id="nombreProveedor validationCustom01"
												name="nombreProveedor" class="form-control" minlength="3" maxlength="15"
												required>
									...
									<div class="form-group">
										...
										<div class="col-sm-10">
											<input type="text" id="empresaProveedor validationCustom02"
												name="empresaProveedor" class="form-control" required>
											<div class="valid-feedback">
									...
									<p class="block">
										<button class="btn btn-primary width-100" name="condicion"
											value="insertar">Agregar proveedor</button>
									</p>
								</form>
							</div>
						</div>
