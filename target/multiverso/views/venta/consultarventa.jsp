											...
											<tbody>
                                                <c:forEach var="ventas" items="${ventas}">
												    <tr>
                                                        ...
                                                        <td class="text-left">
															<a href="ventas?condicion=editar&id=${ventas.getIdDetalleVenta()}">
																<button class="btn btn-primary">Actualizar</button>
															</a>
															<a href="ventas?condicion=eliminar&id=${ventas.getIdDetalleVenta()}" onclick="return eliminar()">
