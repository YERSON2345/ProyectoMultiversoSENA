									...
									<form class="needs-validation" action="ventas" method="post" novalidate>
										...
										<div class="form-group">
											<label for="cantidadVendida validationCustom01"
												class="col-sm-2 control-label">Cantidad vendida</label>
											<div class="col-sm-10">
												<input placeholder="Cantidad vendida (10, 20, 30, ...)" type="text"
													id="cantidadVendida validationCustom01" name="cantidadVendida"
													class="form-control" value="${ventas.getCantidadVendida()}"
													required>
										...
										<br>
										<div class="form-group">
											<label for="precioTotal validationCustom02"
												class="col-sm-2 control-label">Precio total</label>
											<div class="col-sm-10">
												<input placeholder="$10.000, $5.000, ..."
													value="${ventas.getPrecioTotal()}" type="text"
													id="precioTotal validationCustom02" name="precioTotal"
										...
										<button class="btn btn-primary" type="submit" id="form-submit" name="condicion"
											value="editarventa">Enviar</button>
									</form>
								</c:forEach>
							</div>
						</div>
