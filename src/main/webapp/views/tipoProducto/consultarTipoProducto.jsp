					...
					<div class="row">
                        ...
                        <c:forEach var="tipoProducto" items="${tipoProducto}">
                          <tr>
                            ...
                            <c:if test="${tipoProducto.getEstadoTipoProducto() == true}">
                              <td><span class="available"></span></td>
                            </c:if>
                      
                            <c:if test="${tipoProducto.getEstadoTipoProducto() == false}">
                              <td><span class="offline"></span></td>
                            </c:if>
                              <c:if test="${tipoProducto.getEstadoTipoProducto() == true}">
                                <td>
                                  <a href="tipoProducto?accion=estadoTipoProducto&idTipoProducto=${tipoProducto.getIdTipoProducto()}&estadoTipoProducto=false"><button class="btn btn-success" type="button"> Inactivar</button></a>
                                </td>
                              </c:if>
                      
                              <c:if test="${tipoProducto.getEstadoTipoProducto() == false}">
                                <td>
                                  <a href="tipoProducto?accion=estadoTipoProducto&idTipoProducto=${tipoProducto.getIdTipoProducto()}&estadoTipoProducto=true"><button class="btn btn-success" type="button"> Activar</button></a>
                                </td>
                              </c:if>
                              <td>
                                <a href="tipoProducto?accion=eliminar&idTipoProducto=${tipoProducto.getIdTipoProducto()}"> <button type="button" class="btn btn-danger"> Eliminar</button></a><br> 
                                <a href="tipoProducto?accion=editar&idTipoProducto=${tipoProducto.getIdTipoProducto()}"> <button type="button" class="btn btn-primary"> Editar</button></a>
                              </td>
                          </tr>
                        </c:forEach>
					</tbody>
