        ...
        <div class="contact-wrapper animated bounceInUp">
            <div class="contact-form">
                ...
                <form action="tipoProducto" method="post">
                    <p>
                        <label class="font-weight-bold">Nombre Tipo Producto<span class="text-danger">*</span></label> 
                        <input type="text" name="nombre" placeholder="Nmbre del Producto" class="form-control">
                     </p>
                     <div>
