						...
						<ul class="sidebar-nav">
							...
							<li class="sidebar-item">
								<a class="sidebar-link" href="salidas?condicion=formulario">
									<i class="align-middle" data-feather="x-square"></i> <span
										class="align-middle">Agregar</span>
								</a>
							</li>
					...
					<div class="col-10">
						...
						<main class="content">
							<div class="container-fluid p-0">
								...
								<h1 class="h3 mb-3">Consultar Clientes</h1>
										...
										<div class="card">
											<div class="card-header">
												<div class="datatable-container">
													...
													<table class="table table-dark table-hover" border="solid">
														<thead>
															<tr>
																<th></th>
																...
																<th class="text-left">Cambiar Frecuencia</th>
														...
														<tbody>
															...
															<c:forEach var="usuario" items="${datos}">
																...
																<tr>
																	...
																	<c:if
																		test="${usuario.getFrecuenciaCliente() == true}">
																		<td><span>Activo</span></td>
																	</c:if>
																	<c:if
																		test="${usuario.getFrecuenciaCliente() == false}">
																	...
																	<c:if
																		...
																		<td>
																			<a
																				href="cliente?condicion=cambioEstado&id=${usuario.getNoDocCliente()}&estado=false"><button
																	...
																	<c:if
																		...
																		<td>
																			<a
																				href="cliente?condicion=cambioEstado&id=${usuario.getNoDocCliente()}&estado=true"><button
																					class="btn btn-success"
																					type="button">Activar</button> </a>
																		</td>
																	</c:if>
																	<td class="text-left">
																		<a
																		...
																		<br>
																		<a href="cliente?condicion=eliminar&id=${usuario.getNoDocCliente()}"
