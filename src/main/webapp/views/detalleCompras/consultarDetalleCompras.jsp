													...
													<tbody>
														<c:forEach var="detalleCompras" items="${detalleCompras}">
															<tr>
																...
																<td>
																	<a
																		href="detalleCompras?accion=eliminar&idDetalleCompras=${detalleCompras.getIdDetalleCompras()}">
																		<button class="btn btn-danger" type="button">
																			Eliminar</button></a><br>
																	<a
																		href="detalleCompras?accion=editar&idDetalleCompras=${detalleCompras.getIdDetalleCompras()}">
