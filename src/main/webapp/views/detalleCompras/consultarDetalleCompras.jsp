...
<body>
    ...
    <tr>
      <td></td>
      <td>${detalleCompras.getIdDetalleCompras()}</td>
      <td>${detalleCompras.getFechaVencimientoProducto()}</td>
      <td>${detalleCompras.getCantidadCompra()}</td>
      <td>${detalleCompras.getPrecioProveedor()}</td>

        <td>
          <a href="detalleCompras?accion=eliminar&idDetalleCompras=${detalleCompras.getIdDetalleCompras()}"> <button class="btn btn-danger" type="button"> Eliminar</button></a><br> 
          <a href="detalleCompras?accion=editar&idDetalleCompras=${detalleCompras.getIdDetalleCompras()}"> <button class="btn btn-primary" type="button"> Editar</button></a>
        </td>
    </tr>
  </c:forEach>
											</tbody>
