<%@ page language="java" contentType="text/html; charset=utf-8" pageEncoding="utf-8" %>
	<%@ taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c" %>
		...
		<head>
			...
			<title>Añadir Detalle compras</title>
					...
					<div class="content">
						...
						<div class="contact-wrapper animated bounceInUp">
							<div class="contact-form">
								<h3>Agregar Detalle Compras</h3>
								<form action="detalleCompras" method="post">
									<p>
										<label class="font-weight-bold">Fecha De Vencimiento Del Producto<span
												class="text-danger">*</span></label>
										<input type="date" name="fecha" placeholder="Fecha De Vencimiento Del Producto"
											class="form-control">
									</p>
									<p>
										<label class="font-weight-bold">Cantidad De la Compra<span
												class="text-danger">*</span></label>
										<input type="number" name="cantidad" placeholder="Cantidad De la Compra"
											class="form-control">
									</p>
									<p>
										<label class="font-weight-bold">Precio Del Proveedor<span
												class="text-danger">*</span></label>
										<input type="number" name="precio" placeholder="Precio Del Proceedor"
											class="form-control">
									</p>
