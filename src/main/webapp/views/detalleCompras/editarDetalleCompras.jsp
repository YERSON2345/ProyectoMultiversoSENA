...
<head>
	...
	<title>Editar Detalle compras</title>
...
<body>
	...
	<a class="sidebar-link" href="salidas?condicion=consultarSalidas">
		...
		<div class="main">
          ...
          <i class="hamburger align-self-center"></i>
                ...
                <img src="../img/avatars/avatar.jpg" class="avatar img-fluid rounded me-1" alt="Charles Hall" /> <span class="text-dark">Nicolas Peraza</span>
              </a>
    ...
    <form action="detalleCompras" method="post">               
                     <p>
                        <label class="font-weight-bold">Fecha De Vencimiento<span class="text-danger">*</span></label> 
                        <input type="date" name="fecha" value="${detalleCompras.getFechaVencimientoProducto()}" placeholder="Fecha De Vencimiento" class="form-control">
                     </p>
                     <p>
                        <label class="font-weight-bold">Cantidad De la Compra<span class="text-danger">*</span></label> 
                        <input type="number" name="cantidad" value="${detalleCompras.getCantidadCompra()}" placeholder="Cantidad De la Compra" class="form-control">
                     </p>
                     <p>
                        <label class="font-weight-bold">Precio Del Proveedor<span class="text-danger">*</span></label> 
                        <input type="number" name="precio" value="${detalleCompras.getPrecioProveedor()}" placeholder="Precio Del Proveedor" class="form-control">
                     </p>
                     <p>
