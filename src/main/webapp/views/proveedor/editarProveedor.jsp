						...
						<div class="contact-wrapper animated bounceInUp">
							<div class="contact-form">
								...
								<c:forEach var="proveedor" items="${datos}">
									<form action="proveedor" method="post" class="needs-validation" novalidate>

										<div class="form-group">
											<label for="nombreProveedor validationCustom01"
												class="col-sm-2 control-label">Nombre del proveedor</label>
											<div class="col-sm-10">
												<input type="text" id="nombreProveedor validationCustom01"
													name="nombreProveedor" class="form-control"
													value="${proveedor.getNombreProveedor()}" minlength="3"
												...
												<div class="invalid-feedback">
													¡El nombre del proveedor no puede estar vacío o tener menos de 3
													letras!
												</div>
											</div>
										</div>
										...
										<div class="form-group">
											<label for="empresaProveedor validationCustom02"
												class="col-sm-2 control-label">Empresa del proveedor</label>
											<div class="col-sm-10">
												<input type="text" id="empresaProveedor validationCustom02"
													name="empresaProveedor" class="form-control"
													value="${proveedor.getEmpresaProveedor()}" required>
												<div class="valid-feedback">
													¡Empresa colocada con éxito!
												</div>
												<div class="invalid-feedback">
													Por favor, coloque la empresa del proveedor.
												</div>
											</div>
										</div>
										<br><br>
										<p class="block">
											<button class="btn btn-primary" type="submit" id="form-submit"
												name="condicion" value="editarProveedor">Editar</button>
										</p>
									</form>
								</c:forEach>
							</div>
