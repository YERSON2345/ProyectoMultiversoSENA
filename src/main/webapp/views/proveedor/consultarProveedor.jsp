...
swal({
	...
	text: "Se te redireccionará a un formulario para actualizar el proveedor",
	icon: "warning",
	buttons: true,
	dangerMode: true,
  })
  .then((OK) => {
	if (OK) {
		$.ajax({
			url:"proveedor?condicion=editar&id="+id,
	  ...
	  swal("Se esta redireccionando...", {
		icon: "success",
            ...
            if(OK){
                location.href="proveedor?condicion=editar&id="+id
            }
          });
	} else {
				...
				<div class="main">
					...
					<main class="content">
						<div class="container-fluid p-0">
							...
							<h1 class="h3 mb-3">Consultar proveedores</h1>
							<a href="#">									
													...
													<tbody>
														<c:forEach var="proveedor" items="${datos}">
															<tr>
																...
																<td class="text-left">
																	<p class="white">
																		<a onclick="actualizar([[${proveedor.getIdProveedor()}]])">
				...
				$(document).ready(function () {
					...
					$('#datatable').DataTable({
						language: {
							...
							zeroRecords: "No hemos podido encontrar ningún resultado a su busqueda.",
