    ...
    <section class="contact-box">
        <div class="row no-gutters bg-dark">
            ...
            <div class="col-xl-7 col-lg-12 d-flex">
                <div class="container aling-self-center p-6">
                    ...
                    <form class="needs-validation" novalidate id="signupForm">
                        <div class="form-group mb-3">
                          ...
                          <input type="number" min="100000000" max="2200000000" class="form-control" id="validationCustom20" name="noDocumento" placeholder="Ingresa tu número de documento" required>
                        ...
                        <div class="form-group mb-3">
                            <label for="validationCustom04" class="font-weight-bold">Tipo de documento <span class="text-danger">*</span> </label>
                        ...
                        <div class="form-row mb-2">
                            <div class="form-group col-md-6">
                             <label class="font-weight-bold" for="validationCustom02">Nombre<span class="text-danger">*</span> </label>
                          <input type="text" class="form-control" id="validationCustom02" placeholder="Tu nombre" name="Nombre" required>
                          <div class="invalid-feedback">
                          ...
                          <div class="form-group col-md-6">
                            <label for="validationCustom02" class="font-weight-bold">Apellido<span class="text-danger">*</span></label>
                            <input type="text" class="form-control" id="validationCustomUsername" placeholder="Tu Apellido" name="Apellido" required>
                            <div class="invalid-feedback">
                        ...
                        <div class="form-group mb-3">
                            <label for="validationCustom04" class="font-weight-bold">Rol <span class="text-danger">*</span> </label>
                ...
                <br>
                <small class="d-inline-block text-muted">¿Ya tienes cuenta?<a href="usuario?condicion=login">Iniciar sesion</a></small>
                <br>
                </div>
            </div>
        </div>
