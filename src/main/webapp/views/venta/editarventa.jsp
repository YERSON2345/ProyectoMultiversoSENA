        ...
        <div class="contact-wrapper animated bounceInUp">
            <div class="contact-form">
                ...
                <c:forEach var="ventas" items="${ventas}">
					...
					<div class="col-sm-10">
						<input placeholder="$10.000, $5.000, ..." value="${ventas.getPrecioTotal()}" type="text" id="precioTotal validationCustom02" name="precioTotal" class="form-control" required>
				...
				<br><br>
                        <button class="btn btn-primary" type="submit" id="form-submit" name="condicion" value="editarventa">Enviar</button>
                    </form>
                </c:forEach>
            </div>
        </div>
