...
<body>
									...
									<div class="datatable-container">
										<div class="header-tools">
											<div class="tools">
												<ul>
													<li>
														<a href="producto?accion=listar"> <button class="btn btn-primary" type="button">Regresar</button></a><br><br>
													</li>
												</ul>
											</div>
										</div>
    ...
    <tr>
      ...
      <td>
        <a href="ventas?condicion=formulario&id=${producto.getIdProducto()}"> <button class="btn btn-danger" type="button">-</button></a>
      </td>
      <td>
		<a href="producto?accion=Suma"> <button class="btn btn-success" type="button">+</button></a>
      </td>
    </tr>
  </c:forEach>
</tbody>
