									...
									<form action="salidas" method="post" class="needs-validation" novalidate>
										...
										<div class="form-group">
											...
											<label class="col-sm-5 control-label">
												id Producto: ${salidas.getIdProducto()} <br>
												Producto: ${salidas.getNombreProducto()} <br>
												Cantidad actual de producto: ${salidas.getCantidadProducto()} <br>
												Cantidad total que se puede descontar: ${salidas.getCantidadTotal()}
												<br>
											</label>
										</div>
										<div class="form-group">
										...
										<div class="form-group">
											...
											<div class="col-sm-5">
												<input name="idProducto" type="hidden" class="form-control"
													placeholder="20 unidades" value="${salidas.getIdProducto()}">
											</div>
											<div class="col-sm-5">
										...
										<div class="form-group">
											...
											<div class="col-sm-5">
												<input name="cantidadSalidas" type="hidden" class="form-control"
													placeholder="20 unidades" value="${salidas.getCantidadSalida()}">
											</div>
										...
										<div class="form-group">
											...
											<div class="col-sm-5">
												<input name="nombreProducto" type="hidden" class="form-control"
													placeholder="20 unidades" value="${salidas.getNombreProducto()}">
											</div>
										...
										<div class="form-group">
											...
											<div class="col-sm-5">
												<input name="cantidad" type="number" class="form-control"
													placeholder="20 unidades" min="1"
													max="${salidas.getCantidadTotal()}"
													value="${salidas.getCantidadSalida()}" required>
												<div class="invalid-feedback">
													Por favor, tenga en cuenta la cantidad del producto total que se
													puede descontar.
												</div>
										...
										<div class="form-group">
											...
											<label class="col-sm-5 control-label">Motivo por el cual se va a
												descontar</label>
											<div class="col-sm-7">
												<textarea rows="4" cols="50" name="motivo" id="validationCustom01"
													placeholder="Escriba el motivo por el cual se va a descontar dicha cantidad del producto del inventario"
													required>${salidas.getMotivoSalidas()}</textarea>
												<div class="invalid-feedback">
													Por favor, escriba el motivo por el cual desea descontar dicha
										...
										<button class="btn btn-primary" type="submit" id="form-submit" name="condicion"
											value="editarSalida">Enviar</button>
							</div>
							</form>
