													...
													<tbody>
														<c:forEach var="ventas" items="${salidas}">
															<tr>
																...
																<td>
																	<a
																		href="salidas?condicion=editar&id=${ventas.getIdSalida()}&cantidadActualProducto=${ventas.getCantidadProducto()}&cantidadDescontada=${ventas.getCantidadSalida()}">
																		<button
																			class="btn btn-primary">Actualizar</button>
																	</a>
																	<br>
																	<br>
																	<a href="salidas?condicion=eliminar&id=${ventas.getIdSalida()}&nombreP=${ventas.getNombreProducto()}&cantidadS=${ventas.getCantidadSalida()}&cantidadP=${ventas.getCantidadProducto()}"
