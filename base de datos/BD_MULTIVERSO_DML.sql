...
INSERT INTO Producto VALUE(5,"Arroz","libras Arroz Roa",50,1,23000,2);
...
INSERT INTO Usuario VALUE("Nicolas","Peraza","CC","nicolas.peraza10@outlook.com",982738432,"armandocasas",1,2);
...
SELECT U.idDetalleCompras,U.fechaVencimientoProducto,U.cantidadCompra,U.precioProveedor,C.noOrdenCompra, O.nombreProveedor,P.nombreProducto FROM detalleCompras U INNER JOIN 
Compras C ON U.noOrdenCompra = C.noOrdenCompra INNER JOIN Proveedor O ON U.idProveedor = O.idProveedor INNER JOIN Producto P ON U.idProducto = P.idProducto ;
...
SELECT U.idDetalleCompras,C.noOrdenCompra,P.nombreProducto,P.cantidadProducto FROM detalleCompras U INNER JOIN 
Compras C ON U.noOrdenCompra = C.noOrdenCompra INNER JOIN Producto P ON U.idProducto = P.idProducto WHERE U.idDetalleCompras = 1;
